...
var Bot = function (_EventEmitter) {
  ...
  _createClass(Bot, [{
    ...
    value: function downloadFileById(params) {
      ...
      params = params || {};
      if (!params.destination || typeof params.destination !== "string") return Promise.reject(new TypeError("Destination parameter should be passed."));
    ...
    value: function _botCommandEntityHandler(entity) {
      ...
      if (this._events[command] || this._messageTypes.indexOf(command) !== -1) {
