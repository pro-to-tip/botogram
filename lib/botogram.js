...
var Bot = function (_EventEmitter) {
  ...
  _createClass(Bot, [{
    ...
    value: function alert(params) {
      ...
      var chat_ids = params.chat_ids;
      delete params.chat_ids;
      var requests = [];
      var i = 0;
      var length = chat_ids.length;
    ...
    value: function downloadFileById(params) {
      ...
      return new Promise(function (resolve, reject) {
        _this5.getFile(params).then(function (res) {
          ...
          _request3.default.get("https://api.telegram.org/file/bot" + _this5.token + "/" + res.result.file_path).on("response", function (res) {
